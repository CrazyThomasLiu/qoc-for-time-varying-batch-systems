...
Q_learning.load_K(path='Data/policy_iteration_25/q_learning_control_policy20.csv')
...
if save_figure==True:
    ...
    plt.savefig('Q_learning_MIMO_output.pdf')
...
if save_figure==True:
    #plt.savefig('Q_learning_MIMO.jpg', dpi=800)
    plt.savefig('Q_learning_MIMO_control_signal.pdf')
    #plt.savefig('Q_learning.pdf')
