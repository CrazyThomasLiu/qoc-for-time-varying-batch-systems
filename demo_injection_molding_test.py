...
Q_learning.load_K(path='Data/Injection_Molding/policy_iteration_10/q_learning_control_policy20')
...
ax0.legend(['Reference Trajectory','Model-based Initial Control Policy','Q-learning-based Optimal Control Policy','PI-based Indirect ILC'],fontsize=11)
...
if save_figure==True:
    #plt.savefig('Q_learning_injection_molding.jpg', dpi=800)
    plt.savefig('Q_learning_injection_molding.pdf')
