...
for ite in range(iteration_num):
    df_K_q_learning=pd.read_csv('./Data/policy_iteration_25/q_learning_control_policy{}.csv'.format(ite+1), index_col=0)
...
if save_figure==True:
    #plt.savefig('Compare_pi_MIMO.jpg', dpi=800)
    plt.savefig('Compare_pi_MIMO.pdf')
